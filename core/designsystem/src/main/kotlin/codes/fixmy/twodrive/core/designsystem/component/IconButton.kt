...
/**
 * TwoDrive toggle button with icon and checked icon content slots. Wraps Material 3
 * [IconButton].
 *
        ...
        colors = IconButtonDefaults.iconToggleButtonColors(
            ...
            disabledContainerColor = if (checked) {
                MaterialTheme.colorScheme.onBackground.copy(
                    alpha = TwoDriveIconButtonDefaults.DISABLED_ICON_BUTTON_CONTAINER_ALPHA,
                )
            } else {
                Color.Transparent
            },
...
fun IconButtonPreview() {
    TwoDriveTheme {
        TwoDriveIconToggleButton(
            checked = true,
            onCheckedChange = { },
            icon = {
                Icon(
                    imageVector = TwoDriveIcons.FolderBorder,
                    contentDescription = null,
                )
            },
            checkedIcon = {
                Icon(
                    imageVector = TwoDriveIcons.Folder,
                    contentDescription = null,
                )
            },
        )
...
/**
 * TwoDrive icon button default values.
 */
object TwoDriveIconButtonDefaults {
    // TODO: File bug
