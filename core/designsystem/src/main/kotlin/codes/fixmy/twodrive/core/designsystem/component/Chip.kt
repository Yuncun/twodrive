...
/**
 * TwoDrive filter chip with included leading checked icon as well as text content slot.
 *
    ...
    FilterChip(
        ...
        border = FilterChipDefaults.filterChipBorder(
            ...
            disabledBorderColor = MaterialTheme.colorScheme.onBackground.copy(
                alpha = TwoDriveChipDefaults.DISABLED_CHIP_CONTENT_ALPHA,
            ),
            disabledSelectedBorderColor = MaterialTheme.colorScheme.onBackground.copy(
                alpha = TwoDriveChipDefaults.DISABLED_CHIP_CONTENT_ALPHA,
            ),
            selectedBorderWidth = TwoDriveChipDefaults.ChipBorderWidth,
        ),
        colors = FilterChipDefaults.filterChipColors(
            ...
            disabledContainerColor = if (selected) {
                MaterialTheme.colorScheme.onBackground.copy(
                    alpha = TwoDriveChipDefaults.DISABLED_CHIP_CONTAINER_ALPHA,
                )
            } else {
                Color.Transparent
            },
...
fun ChipPreview() {
    TwoDriveTheme {
        TwoDriveBackground(modifier = Modifier.size(80.dp, 20.dp)) {
            TwoDriveFilterChip(selected = true, onSelectedChange = {}) {
                Text("Chip")
            }
        }
    }
...
/**
 * TwoDrive chip default values.
 */
object TwoDriveChipDefaults {
    // TODO: File bug
