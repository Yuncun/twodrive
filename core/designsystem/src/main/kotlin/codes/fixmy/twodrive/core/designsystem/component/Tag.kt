    ...
    Box(modifier = modifier) {
        val containerColor = if (followed) {
            ...
            MaterialTheme.colorScheme.surfaceVariant.copy(
                alpha = TwoDriveTagDefaults.UNFOLLOWED_TOPIC_TAG_CONTAINER_ALPHA,
            )
        }
        TextButton(
            onClick = onClick,
            ...
            colors = ButtonDefaults.textButtonColors(
                ...
                disabledContainerColor = MaterialTheme.colorScheme.onSurface.copy(
                    alpha = TwoDriveTagDefaults.DISABLED_TOPIC_TAG_CONTAINER_ALPHA,
                ),
            ),
        ) {
...
fun TagPreview() {
    TwoDriveTheme {
        TwoDriveTopicTag(followed = true, onClick = {}) {
...
/**
 * TwoDrive tag default values.
 */
object TwoDriveTagDefaults {
