...
/**
 * TwoDrive view toggle button with included trailing icon as well as compact and expanded
...
fun TwoDriveViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = TwoDriveViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        TwoDriveViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) TwoDriveIcons.ViewDay else TwoDriveIcons.ViewList,
...
/**
 * Internal TwoDrive view toggle button content layout for arranging the text label and
 * trailing icon.
 *
 ...
 */
@Composable
private fun TwoDriveViewToggleButtonContent(
...
/**
 * TwoDrive view toggle default values.
 */
object TwoDriveViewToggleDefaults {
    // TODO: File bug
