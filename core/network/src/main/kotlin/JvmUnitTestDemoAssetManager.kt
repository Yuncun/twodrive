...
/**
 * This [DemoAssetManager] implementation reads the merged Android assets of the variant under
 * test. It must remain on the root package for an easier [Class.getResource] with relative paths.
 */
